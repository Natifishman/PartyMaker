...
public class RegisterActivity extends AppCompatActivity {
    ...
    btnRegister.setOnClickListener(
        view -> {
          if (!isAnimating && validateInputs()) {
            animateButtonClick(btnRegister, this::registerUser);
          }
        });
              ...
              if (task.isSuccessful()) {
                ...
                if (task.getException() != null) {
                  ...
                  if (task.getException() instanceof java.io.IOException
                    ...
                    Log.w(TAG, "Network error detected during registration");
                    showError("Network error. Please check your connection and verify the Firebase URL is correct.");
                  } else {
                    // Show error message
  ...
  private void saveUserToDatabase(String uid, String name, String email, String phoneNumber) {
    // Create user object
    ...
    Log.d(TAG, "Saving user to database: " + email);
