...
public class UserAdapter extends ArrayAdapter<User> {
  ...
  public View getView(int position, View convertView, @NonNull ViewGroup parent) {
    ...
    StorageReference storageRef = DBRef.refStorage.child("Users/" + email);
    DBRef.getDownloadUrl(storageRef)
        ...
        .addOnFailureListener(
            exception -> {
              // Handle any errors
              Log.e("UserAdapter", "Error loading image: " + exception.getMessage());
            });
