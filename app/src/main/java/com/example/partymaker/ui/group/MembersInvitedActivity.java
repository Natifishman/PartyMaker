...
public class MembersInvitedActivity extends AppCompatActivity {
  ...
  private void ShowData() {
    ...
    if (FriendKeys == null) {
      ...
      android.util.Log.w("MembersInvitedActivity", "FriendKeys was null, initialized with empty HashMap");
      lv2.setAdapter(new InvitedAdapter(MembersInvitedActivity.this, 0, 0, new ArrayList<>(), adminKey));
      return;
    }
          ...
          public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            for (DataSnapshot data : dataSnapshot.getChildren()) {
              ...
              if (p == null || p.getEmail() == null) {
                android.util.Log.w("MembersInvitedActivity", "Skipping null user or email");
                continue;
              }
